...
void Picture1(HDC hdc, int x, int y, int ej, int ei, void (*pfImage)(HDC hdc, int cx, int cy, COLORREF color)) {
    int cx, i, j;
    unsigned char r, g;
    cx = x;
    i = 0;
    ...
    case WM_PAINT:
        {
            ...
            Picture1(hdc, 30, 30, 8, 8, Image0);
            Picture1(hdc, 400, 30, 2, 14, Image1);
            Picture1(hdc, 30, 400, 4, 6, Image2);
