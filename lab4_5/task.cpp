// task.cpp : Определяет точку входа для приложения.
//
    ...
    case WM_PAINT:
        {
            ...
            // House
            hPen = CreatePen(PS_SOLID, 6, RGB(100, 255, 180));
            ...
            // Right tree
            hPen = CreatePen(PS_SOLID, 4, RGB(68, 175, 105));
            SelectObject(hdc, hPen);
            ...
            // Left tree
            hPen = CreatePen(PS_SOLID, 4, RGB(160, 82, 45));
            SelectObject(hdc, hPen);
            ...
            // Brige
            hPen = CreatePen(PS_SOLID, 18, RGB(112, 128, 144));
            SelectObject(hdc, hPen);
            ...
            // Trash bin
            hPen = CreatePen(PS_SOLID, 5, RGB(77, 80, 85));
            SelectObject(hdc, hPen);
            ...
            // Car
            hPen = CreatePen(PS_SOLID, 3, RGB(252, 76, 2));
            SelectObject(hdc, hPen);
            ...
            hBrush = CreateSolidBrush(RGB(255, 216, 0));
            SelectObject(hdc, hBrush);
            ...
            hPen = CreatePen(PS_SOLID, 20, RGB(0, 0, 0));
            SelectObject(hdc, hPen);
